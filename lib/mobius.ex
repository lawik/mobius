defmodule Mobius do
  ...
  * `:clock` - module that implements the `Mobius.Clock` behaviour. If the
     module also implements the optional `Mobius.Clock.now/0` callback the
     scraper will use it as the time source for sample timestamps.
